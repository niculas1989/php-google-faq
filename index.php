...
//| Scrivere un array in cui poterci muovere per "rifocillare" la pagina
        ...
        'paragraphs' => [
            ...
            <ol>
                <li class="pb-4">
                    ...
                    <ol type="a">
                        <li class="pt-3 pb-3">Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.
                        </li>
                        <li>
...
<style>
    ...
    .header-links:hover {
        color: dodgerblue;
        border-bottom: 2 px solid dodgerblue;
        font-weight: 900;
    }
</style>
...
<body>
    ...
    <header>
        <div id="header-top">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Google_logo_%282010-2013%29.svg/800px-Google_logo_%282010-2013%29.svg.png" alt="Logo GOOGLE">
            <span>
                <a href="#">
                    Privacy e Termini
                </a>
        ...
        <div id="header-bottom">
            <ul class="d-flex">
                <?php foreach ($header_info as $info) : ?>
                    <li class="pe-5 header-links"><?= $info ?></li>
                <?php endforeach ?>
            </ul>
        </div>
    </header>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#">Tutto su Google</a>
                            </li>
                            <li class="nav-item">
